...
plex_config = {"url": os.getenv("PLEX_SERVER"), "token": os.getenv("PLEX_TOKEN")}
...
def get_internet_speed():
    ...
    try:
        ...
        print(
            f"Internet OK - Download: {round(download,2)} Mbps, Upload: {round(upload,2)} Mbps"
        )
